# Python 3.11 Development Container with GUI Support

Docker image with Python 3.11 and GUI application support via VNC.

## Overview

This container provides a complete Python 3.11 development environment with support for running GUI applications through VNC. It's portable across different systems including native Linux, WSL2, and Docker Desktop.

**Image Details:**
- **Docker Hub:** `mdmitry1/python311-dev:latest`
...
```bash
docker run -it -p 5900:5900 -v ~/shared:/shared mdmitry1/python311-dev:latest
```
...
docker push mdmitry1/python311-dev:latest
...
- Check Docker Hub: https://hub.docker.com/r/mdmitry1/python311-dev
- Review this README
- Check Docker and VNC logs

## Version History

- **latest** - Initial release with Python 3.11, VNC support, and GUI capabilities

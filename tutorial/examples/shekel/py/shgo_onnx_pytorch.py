...
def load_model(rootpath=".", model_path='shekel_model_expected.pytorch'):
    """
    ...
    # Load scalers
    with open(rootpath + '/scaler_X_pytorch_expected.pkl', 'rb') as f:
        scaler_X = pickle.load(f)
    with open(rootpath + '/scaler_y_pytorch_expected.pkl', 'rb') as f:
...
def main(rootpath: str = ".") -> str:
    """
    Main function to test PyTorch ONNX model with SHGO optimization.
    ...
    logging.info("=" * 60)
    logging.info("Testing PyTorch ONNX Model")
    logging.info("=" * 60)
